    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="bg-primary text-primary-foreground p-4 shadow-lg">
        <div className="max-w-4xl mx-auto flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold">PIE Educativo</h1>
      ...
      <main className="max-w-4xl mx-auto p-4 space-y-8">
        ...
        <div className="text-center py-8">
          <h2 className="text-3xl font-bold text-foreground mb-4">¡Bienvenidos a PIE Educativo!</h2>
              ...
              <TabsContent value="teacher" className="space-y-4 mt-6">
                <div className="space-y-4">
                  ...
                  <Button
                    ...
                    size="lg"
                    onClick={() => setAppState("teacher-login")}
                  >
